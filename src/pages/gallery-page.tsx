    ...
    <div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Enhanced Category Tabs with horizontal scroll for mobile - Solution 5 */}
          <Tabs
            defaultValue="all"
            value={category}
          ...
          >
            <div className="mb-8 sm:mb-12">
              <div className="w-full overflow-x-auto pb-3 scrollbar-hide">
                <div className="inline-flex min-w-max mx-auto">
                  <TabsList className="bg-cream-dark border border-border p-1 rounded-xl inline-flex">
                    {categories.map((cat) => (
                      <TabsTrigger
                        key={cat.id}
                        value={cat.id}
                        className={cn(
                          ...
                          "px-3 py-2 sm:px-5 sm:py-3 rounded-lg font-medium transition-all duration-300",
                          "flex items-center gap-2 touch-friendly whitespace-nowrap",
                          "text-sm sm:text-base" // Consistent text size
                        )}
                      >
                        {/* Keep icons but make them smaller on mobile */}
